/////////////////////////////////////////////////////////////////////////////
//
//      Program 4 - otp_dec_d - Operating System
...
char* decrypt(char * cipher, char* key, int length)
{
        int i;
        for(i = 0; i < length-1; i++)
        {
                ...
                cipher_index = (cipher_index - key_index + 27) % 27;
        	...
        	if (establishedConnectionFD < 0) error("ERROR on accept");
                ...
                switch (child_pid)
                {
                        ...
                        case 0:
                                ...
                                /* verification check */
                                if(strncmp(buffer, "DECRYPTION", 10) == 0)
                                {
                                	...
                                	if (charsRead < 0) error("ERROR writing to socket");
                                        ...
                                        /********** DECRYPT **********/
                                        decrypt(cipher, key, length);

                                        // Send a decrypted cipher back to the client
